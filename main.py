...
#pprint(my_job.scraped_jobs_title())
'''
out put should be list of all job titles 
['ACCOUNTANT ',
 'Accountant ( COST ACCOUNTANT ; FACTORY EXP MUST) ',
 'Marketing  Department Manger ',
 'Project Director ',
 'Manager - ERP Management and Support ',
 'Import and Export Coordinator ',
 'Hygiene & Sanitation Officer ',
 'Tender Division Manager ',
...
#my_job = EthioJobs('manager')
#pprint(my_job.scraped_campany_jobs_dead_line())
'''
['Dec 14, 2021',
 'Dec 14, 2021',
 'Dec 11, 2021',
...
# if you want to see latest available goverment jobs
#job = TableData()
